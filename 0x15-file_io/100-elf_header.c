...
/**
 * check_elf - Checks if file is an EL.
 * @e_ident:array of ELF numbers.
 * Description: checks If file is not an ELF file, exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * main - displays info of ELF header at the start of an ELF file.
